...
(display " = (1 3 (2 5) (2 5 (2 5)) 7)") (newline)

(display "nested has dups after reduce") (newline)
(nested-reduce '(1 3 (2 5 (2 5)) (2 5 (2 5) (2 5)) 3 7 1))
(display " = (1 3 (2 5 (2 5)) 7)") (newline)

(display "no dups, no nests") (newline)
(nested-reduce '(1 3 5 6 7 88))
(display " = (1 3 5 6 7 88)") (newline)

(display "no dups, nests") (newline)
(nested-reduce '(1 3 5 (5 8 9) 6 7 88))
(display " = (1 3 5 (5 8 9) 6 7 88)") (newline)
(nested-reduce '((5 8 9) 1 3 5 6 7 88))
(display " = ((5 8 9) 1 3 5 6 7 88)") (newline)
(nested-reduce '(1 3 5 6 7 88 (5 8 9)))
(display " = (1 3 5 6 7 88 (5 8 9))") (newline)

(display "dups, no nests") (newline)
(nested-reduce '(1 2 3 4 4 5 6 7))
(display " = (1 2 3 4 5 6 7)") (newline)
(nested-reduce '(4 4 1 2 3 5 6 7))
(display " = (4 1 2 3 5 6 7)") (newline)
(nested-reduce '(1 2 3 5 6 7 4 4))
(display " = (1 2 3 5 6 7 4)") (newline)

(display "three dups") (newline)
(nested-reduce '(1 2 3 4 4 4 5 6 7))
(display " = (1 2 3 4 5 6 7)") (newline)
(nested-reduce '(4 4 4 1 2 3 5 6 7))
(display " = (4 1 2 3 5 6 7)") (newline)
(nested-reduce '(1 2 3 5 6 7 4 4 4))
(display " = (1 2 3 5 6 7 4)") (newline)

(display "four dups") (newline)
(nested-reduce '(1 2 3 4 4 4 4 5 6 7))
(display " = (1 2 3 4 5 6 7)") (newline)
(nested-reduce '(4 4 4 4 1 2 3 5 6 7))
(display " = (4 1 2 3 5 6 7)") (newline)
(nested-reduce '(1 2 3 5 6 7 4 4 4 4))
(display " = (1 2 3 5 6 7 4)") (newline)

(display "list dups, no nests") (newline)
(nested-reduce '(1 2 3 (12 13) (12 13) 5 6 7))
(display " = (1 2 3 (12 13) 5 6 7)") (newline)
(nested-reduce '((12 13) (12 13) 1 2 3 5 6 7))
(display " = ((12 13) 1 2 3 5 6 7)") (newline)
(nested-reduce '(1 2 3 5 6 7 (12 13) (12 13)))
(display " = (1 2 3 5 6 7 (12 13))") (newline)

(display "three list dups") (newline)
(nested-reduce '(1 2 3 (12 13 14) (12 13 14) (12 13 14) 5 6 7))
(display " = (1 2 3 (12 13 14) 5 6 7)") (newline)
(nested-reduce '((12 13 14) (12 13 14) (12 13 14) 1 2 3 5 6 7))
(display " = ((12 13 14) 1 2 3 5 6 7)") (newline)
(nested-reduce '(1 2 3 5 6 7 (12 13 14) (12 13 14) (12 13 14)))
(display " = (1 2 3 5 6 7 (12 13 14))") (newline)

(display "nested dups") (newline)
(nested-reduce '(1 2 3 (4 4) 5 6 7))
(display " = (1 2 3 (4) 5 6 7)") (newline)
(nested-reduce '((4) 1 2 3 5 6 7))
(display " = ((4) 1 2 3 5 6 7)") (newline)
(nested-reduce '(1 2 3 5 6 7 (4 4)))
(display " = (1 2 3 5 6 7 (4))") (newline)

(display "three nested dups") (newline)
(nested-reduce '(1 2 3 (4 4 4) 5 6 7))
(display " = (1 2 3 (4) 5 6 7)") (newline)
(nested-reduce '((4 4 4) 1 2 3 5 6 7))
(display " = ((4) 1 2 3 5 6 7)") (newline)
...
(display "four nested dups") (newline)
(nested-reduce '(1 2 3 (4 4 4 4) 5 6 7))
(display " = (1 2 3 (4) 5 6 7)") (newline)
(nested-reduce '((4 4 4 4) 1 2 3 5 6 7))
(display " = ((4) 1 2 3 5 6 7)") (newline)
